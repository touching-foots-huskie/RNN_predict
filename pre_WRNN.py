...
def main():
    ...
    # data preparation:
    dataX, dataY, original_X = prepare_pre_train_data(num=data_num, data_range=data_range,
                                                      look_back=look_back, noise_level=1e-2)
    val_dataX, val_dataY, val_original_X = prepare_pre_train_data(num=batch_size, data_range=data_range,
                                                                  look_back=look_back, noise_level=1e-2)
    ...
    with tf.Session() as sess:
        ...
        #  save:
        saver.save(sess, 'train_log/pre_WRNN')
